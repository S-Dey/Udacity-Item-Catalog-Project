...
## Known Issue
This app might show an empty name if you sign in with a custom-domain-based Google account. For instance, if you use a custom domain based Google account (non `gmail.com` address), the app might show an empty name. So, make sure to use an email with `gmail.com` domain only.
